...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField("Password", validators=[InputRequired(), Length(min=4, message="Your password must be minimum 4 characters long.")])
